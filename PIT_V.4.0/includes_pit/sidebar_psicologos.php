...
$usuario = $_SESSION["usuario"] ?? "Psicología";
?>
<!-- BARRA SUPERIOR -->
<header class="topbar-psicologos">
    <div class="topbar-left">
        ...
        <div class="topbar-logo">
            ...
            <div><h2>Psicología TESCHA</h2><span>Departamento de Psicología</span></div>
        </div>
    </div>
...
<aside id="sidebarPsicologos" class="sidebar-psicologos">
    <div class="sidebar-header">
        <div class="sidebar-avatar"><i class="fas fa-brain"></i></div>
        <div><h3>Psicología</h3><span>Panel Principal</span></div>
    </div>
    <nav class="sidebar-menu">
        <ul>
            <li><a href="<?= $base_url ?>/MOD_PSICOLOGOS/inicio.php" class="<?= basename($pagina_actual)=='inicio.php'?'activo':'' ?>"><i class="fas fa-house"></i><span>Inicio</span></a></li>
            <li><a href="<?= $base_url ?>/MOD_PSICOLOGOS/canalizaciones/"><i class="fas fa-hand-holding-heart"></i><span>Canalizaciones</span></a></li>
        </ul>
    </nav>
    <div class="sidebar-footer">
        <i class="fas fa-brain"></i>
        <div><strong>Psicología</strong><small>TESCHA</small></div>
    </div>
</aside>

<link rel="stylesheet" href="<?= $base_url ?>/includes_pit/sidebar_psicologos.css">
<script src="<?= $base_url ?>/includes_pit/sidebar_psicologos.js"></script>
<script>
