...
/*
    ARCHIVO ACTUAL:
    C:\XAMPPP\htdocs\SIST V.4.0\vista_tutor\index.php
...
include("../includes/sidebar-sist.php"); 
...
/*
    ...
    LA BASE DE DATOS GUARDA SOLAMENTE EL NOMBRE DEL ARCHIVO:
            ...
            <div class="grid-tutores">
                ...
                <?php while ($tutor = $resultado->fetch_assoc()) { ?>
                    ...
                    /*
                        ...
                        /SIST%20V.4.0/PIT_V.4.0/uploads/tutores/
                        tutor_3_8b82770b72bcd16c.jpg
                    */
